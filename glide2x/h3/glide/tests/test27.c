...
int main( int argc, char **argv) {
    ...
    while( frames-- && tlOkToRender()) {
        ...
        a.x = tlScaleX(((float)rRandom( 0, 100 ))/100.0f) + SNAP_BIAS;
        a.y = tlScaleY(((float)rRandom( 0, 100 ))/100.0f) + SNAP_BIAS;
        a.r = 255.0f;

        b.x = tlScaleX(((float)rRandom( 0, 100 ))/100.0f) + SNAP_BIAS;
        b.y = tlScaleY(((float)rRandom( 0, 100 ))/100.0f) + SNAP_BIAS;
        b.g = 255.0f;

        c.x = tlScaleX(((float)rRandom( 0, 100 ))/100.0f) + SNAP_BIAS;
        c.y = tlScaleY(((float)rRandom( 0, 100 ))/100.0f) + SNAP_BIAS;
        c.b = 255.0f;
