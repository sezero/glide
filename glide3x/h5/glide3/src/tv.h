...
// Voodoo2 Windows 98 control panel. 
** 
** 12    5/14/99 9:43p Stb_rbissell
** tvout and dfp changes
** 
** 11    3/31/99 1:38p Pratt
** added define for TV composite (Stuart did it but forgot to check in
** before he left)
** 
...
#define QUERYGETOVERRIDE        (0x347)          // Get Connector autosense override
...
#define QUERYSETOVERRIDE        (0x367)         // Set Connector autosense override
...
#define QUERYTVOUTPUT           (0x502)         // is tv output on, or off?
...
#define TV_TYPE_UNKNOWN   (0x00000008L)        // for broken bt868 rev d
...
**
**  INPUT:      qin.dwSubFunc = QUERYGETSTANDARD or QUERYGETOVERRIDE
...
// these describe use of BIOS_SCRATCH_REGISTER_2 (index 0x1e)  bits
